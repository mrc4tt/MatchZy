...
public class SmokeGrenadeProjectile
{
    ...
    public static MemoryFunctionWithReturn<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr, float, int, IntPtr> CSmokeGrenadeProjectile_CreateFunc =
        new(smokeGrenadeProjectileSig);
