...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public FakeConVar<bool> autoPauseEnabled = new("matchzy_autopause_enabled",
            "Whether to automatically pause when a team has fewer than minimum players. Replaces sv_matchpause_auto_5v5. Default: true", true);

        public FakeConVar<int> autoPauseMinPlayers = new("matchzy_autopause_minplayers",
            "Minimum players required per team before auto-pause triggers. Default: 5", 5);

        public FakeConVar<int> autoResumeDelay = new("matchzy_autopause_resume_delay",
            "Delay in seconds before auto-resuming when teams are balanced. Default: 3", 3);
