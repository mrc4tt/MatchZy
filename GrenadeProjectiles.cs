...
public static class GrenadeFunctions
{
    ...
    private const string CSmokeGrenadeProjectile_Create_Linux = @"55 4C 89 C1 48 89 E5 41 57 45 89 CF 41 56 49 89 FE";
    ...
    private const string CHEGrenadeProjectile_Create_Linux = "55 4C 89 C1 48 89 E5 41 57 49 89 D7";
    ...
    private const string CDecoyProjectile_Create_Linux = "55 4C 89 C1 48 89 E5 41 57 45 89 CF 41 56 49 89 D6 48 89 F2 48 89 FE 41 55 49 89 FD 41 54 48 8D 3D ?? ?? ?? ?? 4D 89 C4 53 48 83 EC ?? E8 ?? ?? ?? ?? 45 31 C0";
