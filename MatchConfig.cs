...
namespace MatchZy
{
    public class MatchConfig
    {
        ...
        [JsonPropertyName("remote_log_auth_key")]
        public string RemoteLogAuthKey { get; set; } = "";

        [JsonPropertyName("remote_log_auth_value")]
        public string RemoteLogAuthValue { get; set; } = "";
    }
}
