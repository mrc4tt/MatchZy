...
public partial class MatchZy
{
    ...
    {
        if (!isMatchLive || victim == null || !victim.IsValid || victim.IsBot) return;
        ...
        if (death.KillerSteamId.HasValue)
        {
            ...
            var recentTeammateDeaths = roundDeaths
                .Where(d => d.VictimTeam == killerTeam && 
    ...
    private void UpdateAliveCounts()
    {
        ...
        {
            if (player == null || !player.IsValid || player.IsBot) continue;
            if (player.PlayerPawn?.Value == null || player.PlayerPawn.Value.Health <= 0) continue;
    ...
    private void CheckClutchSituation(CsTeam victimTeam)
    {
        ...
        if (clutchInProgress) return;  // Already tracking a clutch
        ...
        {
            // T is clutching
            clutcher = Utilities.GetPlayers().FirstOrDefault(p => 
                p != null && p.IsValid && !p.IsBot && 
                p.TeamNum == (int)CsTeam.Terrorist &&
                p.PlayerPawn?.Value != null && p.PlayerPawn.Value.Health > 0);
            opponents = aliveCT;
        }
        ...
        if (clutcher != null && opponents >= 1 && opponents <= 5)
        {
            ...
            switch (opponents)
            {
                case 1: stats.Clutch1v1Attempts++; break;
                case 2: stats.Clutch1v2Attempts++; break;
                case 3: stats.Clutch1v3Attempts++; break;
                case 4: stats.Clutch1v4Attempts++; break;
                case 5: stats.Clutch1v5Attempts++; break;
            }
    ...
    {
        if (!clutchPlayer.HasValue || !advancedStats.ContainsKey(clutchPlayer.Value)) return;
        
        var clutcherPlayer = Utilities.GetPlayers().FirstOrDefault(p => 
            p != null && p.IsValid && !p.IsBot && p.SteamID == clutchPlayer.Value);
        
        if (clutcherPlayer == null) return;
        ...
        if (clutchWon)
        {
            ...
            {
                case 1: stats.Clutch1v1Wins++; break;
                case 2: stats.Clutch1v2Wins++; break;
                case 3: stats.Clutch1v3Wins++; break;
                case 4: stats.Clutch1v4Wins++; break;
                case 5: stats.Clutch1v5Wins++; break;
            }
    ...
    /// </summary>
    public async Task WriteMatchStatsJsonAsync(MatchStatsJson matchStats, string demoFilename, string gameDirectory)
    {
        try
        {
    ...
    private MatchStatsPlayer CreateMatchStatsPlayer(StatsPlayer player, string teamName, int rounds)
    {
        ...
        double rating = 0.0073 * kastPercent + 
                       0.3591 * kpr - 
                       0.5329 * dpr + 
                       0.2372 * impact + 
                       0.0032 * adr + 
...
public class MatchStatsJson
{
    ...
    [JsonPropertyName("total_rounds")] public int TotalRounds { get; set; }
    [JsonPropertyName("demo_filename")] public string DemoFilename { get; set; } = "";
    [JsonPropertyName("winner")] public string Winner { get; set; } = "";
    [JsonPropertyName("team1")] public TeamStatsJson Team1 { get; set; } = new();
    [JsonPropertyName("team2")] public TeamStatsJson Team2 { get; set; } = new();
}
...
public class TeamStatsJson
{
    ...
    [JsonPropertyName("players")] public List<MatchStatsPlayer> Players { get; set; } = new();
}
...
public class MatchStatsPlayer
{
    ...
    [JsonPropertyName("headshot_kills")] public int HeadshotKills { get; set; }
    [JsonPropertyName("hs_percent")] public double HsPercent { get; set; }
    [JsonPropertyName("multi_kills")] public int MultiKills { get; set; }
    [JsonPropertyName("5k")] public int Kills5 { get; set; }
    [JsonPropertyName("4k")] public int Kills4 { get; set; }
    [JsonPropertyName("3k")] public int Kills3 { get; set; }
    ...
    [JsonPropertyName("trade_kills")] public int TradeKills { get; set; }
    [JsonPropertyName("1v1")] public string Clutch1v1 { get; set; } = "0/0";
    [JsonPropertyName("1v2")] public string Clutch1v2 { get; set; } = "0/0";
    [JsonPropertyName("flash_assists")] public int FlashAssists { get; set; }
    [JsonPropertyName("utility_damage")] public int UtilityDamage { get; set; }
}
